...
import sys
sys.path.append("../")
from utils_freq.freq_fourier_loss import  fft_L1_loss_color,decide_circle
...
def compute_g_loss(nets, args, x_real, y_org, y_trg, z_trgs=None, x_refs=None, masks=None, gauss_kernel=None, mask_h= None, index=None):
